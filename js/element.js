...
*/
    ...
    _.Wa = function (a) {
      if (a instanceof Ua) return a.og;
      throw Error("A");
    };
    _.Za = function (a) {
      ...
      c.prototype.delete = function (h) {
        ...
        return h.xa && h.list
          ? (h.list.splice(h.index, 1),
            ...
            (h.xa.gb.next = h.xa.next),
            (h.xa.next.gb = h.xa.gb),
            (h.xa.head = null),
            this.size--,
            !0)
          : !1;
          ...
          if (n && mb(h[0], m))
            for (h = 0; h < n.length; h++) {
              ...
              if ((l !== l && r.key !== r.key) || l === r.key)
                return { id: m, list: n, index: h, xa: r };
            }
          return { id: m, list: n, index: -1, xa: void 0 };
        },
        e = function (h, l) {
          var m = h[1];
          return jb(function () {
            if (m) {
              for (; m.head != h[1]; ) m = m.gb;
              for (; m.next != m.head; )
    ...
    _.kd.prototype.ye = _.wd;
    _.kd.prototype.contains = _.xd;
    _.kd.prototype.ac = _.yd;
    var Ad = function () {
      this.id = "b";
    };
    ...
    Kd.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.Lc = !1))
        : ((b = new Id(b, this.src, f, !!d, e)), (b.Lc = c), a.push(b));
      return b;
    };
    ...
    Kd.prototype.nc = function (a, b, c, d) {
      a = this.g[a.toString()];
      var e = -1;
      a && (e = Ld(a, b, c, d));
      return -1 < e ? a[e] : null;
    ...
    var Ld = function (a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.uc && f.listener == b && f.capture == !!c && f.fd == d) return e;
      }
      return -1;
    };
    ...
    _.Yd = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.wa(d) ? !!d.capture : !!d),
          ...
          _.Gd(a)
            ? a.Ra(b, c, d, e)
            : a && (a = _.Ud(a)) && (b = a.nc(b, c, d, e)) && _.Zd(b);
    };
    _.Zd = function (a) {
...
*/
    ...
    Db.Ja = We;
    Db.Ja.g = { ef: 0, Se: 1, TIMEOUT: 2, cf: 3, Hd: 4 };
    var Ye = function () {
      Zb.call(this);
      this.T = null;
      this.g = {};
    ...
    _.k.Ge = function (a, b) {
      if (!(this instanceof Ye)) this.Ge(a, b);
      ...
      if (0 !== e.length) {
        ...
        a = (0, _.A)(this.B.H, this.B, _.ua(e), this.g, {
          ...
          te: function (f) {
            ...
            401 == f
              ? (gf(d, new Db.Ja(Db.Ja.g.ef, f)), (d.h.length = 0))
              : 410 == f
              ? (hf(d, new Db.Ja(Db.Ja.g.cf, f)), jf(d))
              : 3 <= d.D
              ? (hf(d, new Db.Ja(Db.Ja.g.Se, f)), jf(d))
              : d.N(d.o, !0, 8001 == f);
          },
          Ni: (0, _.A)(this.aa, this),
        });
    ...
    var ff = function (a, b) {
      ...
      $e = function (a) {
        a.j == a.F &&
          ((a.j = null),
          a.F.onLoad((0, _.A)(a.zf, a)) && gf(a, new Db.Ja(Db.Ja.g.Hd)),
          bf(a));
      },
      na = function (a) {
        if (a.j) {
          ...
          a.Xa() ||
            (a.g[b].onLoad((0, _.A)(a.zf, a)) && gf(a, new Db.Ja(Db.Ja.g.Hd)),
            _.ta(a.A, b),
            _.ta(a.l, b),
            0 === a.l.length && jf(a),
    ...
    var hf = function (a, b) {
      ...
      gf = function (a, b) {
        ...
        for (e = 0; e < c.length; e++) a.g[c[e]] && a.g[c[e]].te(b);
        a.o.length = 0;
        bf(a);
      },
      jf = function (a) {
    ...
    _.k.keys = function () {
      return tf(this.nb(!0)).h();
    };
    _.k.values = function () {
      return tf(this.nb(!1)).h();
    };
    ...
    _.sg.prototype.za = function (a) {
      a = a({}, this.j ? this.j.g() : {});
      this.h(
        null,
        "function" == typeof _.tg && a instanceof _.tg ? a.Ab : null
      );
    };
    ...
    _.I.prototype.rb = function (a, b, c, d) {
    ...
    Ug.prototype.g = function () {
      ...
      if ("undefined" != typeof XDomainRequest) return new Vg();
      throw Error("S");
    };
    var Vg = function () {
      ...
      this.status = -1;
      this.statusText = "";
      this.g.onload = (0, _.A)(this.Ig, this);
      this.g.onerror = (0, _.A)(this.Ue, this);
      this.g.onprogress = (0, _.A)(this.Yh, this);
      this.g.ontimeout = (0, _.A)(this.ai, this);
    };
    _.k = Vg.prototype;
    ...
    Vg.prototype.getAllResponseHeaders = function () {
    ...
    $g = ["POST", "PUT"];
    _.ah = [];
    _.Yg.prototype.T = function () {
      this.R();
      _.ta(_.ah, this);
    };
    _.Yg.prototype.send = function (a, b, c, d) {
        ...
        ch(this),
          0 < this.o &&
            ((this.M = dh(this.g))
              ...
              : (this.B = _.Xg(this.U, this.o, this))),
          (this.A = !0),
          this.g.send(a),
          (this.A = !1);
      } catch (g) {
    ...
    _.Yg.prototype.abort = function (a) {
      this.g &&
        this.h &&
        ((this.h = !1),
        (this.j = !0),
    ...
    _.Yg.prototype.P = function () {
      this.Xa() || (this.G || this.A || this.j ? gh(this) : this.W());
    };
    ...
    var gh = function (a) {
        if (
          a.h &&
          "undefined" != typeof xb &&
          (!a.D[1] || 4 != _.hh(a) || 2 != a.Na())
        )
          if (a.A && 4 == _.hh(a)) _.Xg(a.P, 0, a);
          else if ((a.dispatchEvent("readystatechange"), 4 == _.hh(a))) {
            a.h = !1;
            try {
              a.pc()
    ...
    _.Yg.prototype.isActive = function () {
      return !!this.g;
    };
    _.Yg.prototype.pc = function () {
      var a = this.Na();
      a: switch (a) {
        case 200:
        case 201:
    ...
    _.Yg.prototype.Na = function () {
      try {
        return 2 < _.hh(this) ? this.g.status : -1;
      } catch (a) {
        return -1;
      }
    };
    _.Yg.prototype.Ca = function () {
      try {
    ...
    var lh = function (a, b, c, d, e) {
      ...
      mh = function (a, b, c, d, e) {
        ...
        for (
          var h = function (r, p) {
              for (
                var q = [], x = 0, C = Math.floor(r.length / p) + 1, L = 0;
                L < p;
                L++
              ) {
                var T = (L + 1) * C;
          ...
          var m = oh(a, l, !!e, !0);
          if (2e3 >= m.length) {
            if ((l = ph(a, l, e))) f.push(l), Se(g, l.g);
      ...
      ph = function (a, b, c) {
        ...
        if (a.B)
          ...
          var e = new rh(),
            f = new _.Yg(0 < a.j.length ? new Ug() : void 0);
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_GB.Tt16qV2Ai0Q.O/am=wA/d=1/rs=AN8SPfqm9wJ_jcxnx6dYnwQ7a_Pney8ybQ/m=el_conf
// Configure Constants
(function () {
  ...
  (function () {
    ...
    _loadCss(c._ps);
    _loadJs(
      "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.en_GB.Tt16qV2Ai0Q.O/am\x3dAAQ/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfqgUqx7bkFmbPL5iBDeQjebnTZ2-w/m\x3del_main"
    );
    _exportMessages();
    _exportVersion("TE_20240401");
  })();
})();
